        ...
        try {
            ...
            let productNew = Array(product).map(function (produ) {
                ...
                return {
                    id: produ.id,
                    name: produ.name,   
                    image: ('C:\\Users\\Gian Quaranta\\Documents\\Curso Desarrollo Web Full Stack - Digital House\\PracticoIntegrador\\RepositorioLocalPracticoIntegrador\\clon_grupo_8_tierradegenios\\grupo_8_TierradeGenios\\backend\\Public\\img\\products\\' + produ.image),
                    min: produ.min,
                    max: produ.max,
